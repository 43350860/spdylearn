...
<Workset version="7">
  <WorksetName>okhttp-protocols-1.2.1</WorksetName>
  <Options auto-reload="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/media/jm/MobileDisk/Projects/okhttp/okhttp_github/okhttp-protocols/target/classes</ClasspathPart>
  </Classpath>
  <ViewFilters>
