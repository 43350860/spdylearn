...
<Workset version="7">
  <WorksetName>alipay-transport</WorksetName>
  <Options auto-reload="no" />
  <Classpath shortContainerNames="yes">
    <ClasspathPart type="bin-class">/home/jm/WorkDisk/projects/android-phone/android-phone-mobilesdk-8.4/transport/bin/classes</ClasspathPart>
  </Classpath>
  <ViewFilters>
